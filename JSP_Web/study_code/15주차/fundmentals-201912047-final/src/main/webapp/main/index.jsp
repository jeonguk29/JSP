<%@ page contentType="text/html;charset=UTF-8" language="java" %> <!-- 이페이지 읽을때 인코딩 여기가 페이지 지시자 -->
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
    ...
    <body>
        <!-- Navigation 메뉴관련-->
        <%@include file="nav.jsp"%> <!-- 컴파일 시점에 포함 인클루드 지시자 톰켓에게 알려줌 이 인클루드 처리해줘

        지시자 중 3가지 페이지, 인클루드, 태그 라이브러리 지시자     맨위가 페이지 지시자임
        -->
        <!-- Page Header-->
        ...
        <!-- Footer-->
        <%@include file="footer.jsp"%> <!-- 컴파일 시점에 포함-->
        <!-- Bootstrap core JS-->
