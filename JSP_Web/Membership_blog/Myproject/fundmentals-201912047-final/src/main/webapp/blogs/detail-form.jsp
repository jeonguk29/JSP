                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            ...
                            <form action="update.do?id=${blog.id}" method="post" id="contactForm" >
                                    ...
                                    <input name="regdate" type="date" max="2100-12-30" min="2000-01-01"  value="${blog.regdate}" placeholder="Enter your name..." />
                                ...
                                <a href="delete.do?id=${blog.id}&email=${blog.email}">
                                    <button class="btn btn-primary text-uppercase" id="submitButton" type="button">Delete</button>
                                </a>
